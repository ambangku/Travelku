...
<div class="section-content section-dashboard-home" data-aos="fade-up">
  <div class="container-fluid">
    <div class="dashboard-heading">
      ...
      <div class="store-breadcrumbs" data-aos="fade-down" data-aos-delay="100">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <nav>
                <ol class="breadcrumb">
                  <li class="breadcrumb-item">
                    <a href="{{ route('dashboard-transaction') }}">Transactions
                    </a>
                  </li>
                ...
                <div class="col-12 col-md-8">
                  <div class="row">
                    <div class="col-12 col-md-6">
                      ...
                      <di class="product-subtitle">{{ $transaction->transaction->user->name }}
                    </div>
                    <div class="col-12 col-md-6">
                    ...
                    <div class="col-12 col-md-6">
                      ...
                      <div class="product-subtitle">
                        Rp. {{ $transaction->transaction->total_price }}
                      </div>
                    </div>
                    <div class="col-12 col-md-6">
                  ...
                  <div class="col-12">
                    <div class="row">
                      <div class="col-12 col-md-6">
                        ...
                        <di class="product-subtitle">{{ $transaction->transaction->user->address_one }}
                      </div>
                      <div class="col-12 col-md-6">
